...
Match!: _ @stdlib(func(_~pattern: string, _~name: string, _~os: string | *"unix") -> bool)
...
Clean!: _ @stdlib(func(_~path: string, _~os: string | *"unix") -> string)

// ToSlash returns the result of replacing each separator character
// in path with a slash ('/') character. Multiple separators are
// replaced by multiple slashes.
ToSlash!: _ @stdlib(func(_~path: string, _~os: string) -> string)

// FromSlash returns the result of replacing each slash ('/') character
// in path with a separator character. Multiple slashes are replaced
// by multiple separators.
FromSlash!: _ @stdlib(func(_~path: string, _~os: string) -> string)

// SplitList splits a list of paths joined by the OS-specific ListSeparator,
// usually found in PATH or GOPATH environment variables.
// Unlike strings.Split, SplitList returns an empty slice when passed an empty
// string.
SplitList!: _ @stdlib(func(_~path: string, _~os: string) -> [...string])
...
Split!: _ @stdlib(func(_~path: string, _~os: string | *"unix") -> [...string])
...
// The default value for os is Unix.
Join!: _ @stdlib(func(_~elem: [...string], _~os: string | *"unix") -> string)

// Ext returns the file name extension used by path.
// The extension is the suffix beginning at the final dot
// in the final element of path; it is empty if there is
// no dot. The default value for os is Unix.
Ext!: _ @stdlib(func(_~path: string, _~os: string | *"unix") -> string)
...
Resolve!: _ @stdlib(func(_~dir: string, _~sub: string, _~os: string | *"unix") -> string)
...
Rel!: _ @stdlib(func(_~basepath: string, _~targpath: string, _~os: string | *"unix") -> string)
...
// The default value for os is Unix.
Base!: _ @stdlib(func(_~path: string, _~os: string | *"unix") -> string)
...
// The default value for os is Unix.
Dir!: _ @stdlib(func(_~path: string, _~os: string | *"unix") -> string)
...
// a validator.
IsAbs!: _ @stdlib(func(_~path: string, _~os: string | *"unix") -> bool)
...
VolumeName!: _ @stdlib(func(_~path: string, _~os: string | *"unix") -> string)
