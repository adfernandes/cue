...
// constraint.
Duration!: _ @stdlib(validator(string))
...
FormatDuration!: _ @stdlib(func(_~d: int) -> string)
...
ParseDuration!: _ @stdlib(func(_~s: string) -> int)
...
FormatString!: _ @stdlib(func(_~layout: string, _~value: string) -> string)
...
// interpreted as UTC.
Parse!: _ @stdlib(func(_~layout: string, _~value: string) -> string)
