...
// The String methods for Token and RelPos are both generated by this single
// stringer run; loading and type-checking the package costs more than
// stringer's own work, so a run per type would repeat it needlessly.
//
//go:generate go tool stringer -type=Token,RelPos -linecomment -output=stringer_gen.go
