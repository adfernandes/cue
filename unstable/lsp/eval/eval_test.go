...
`,
			...
			expectCompletions: map[offsetRange]fieldEmbedCompletions{
				...
				or(17, 21): {f: []string{"w", "y"}, e: []string{"x", "z"}},
				or(21, 23): {f: []string{"w", "y"}},
				or1(23):    {e: []string{"w", "x", "y", "z"}},
				or1(25):    {e: []string{"w", "x", "y", "z"}},
				or(26, 28): {f: []string{"w", "y"}, e: []string{"x", "z"}},
				or(28, 30): {f: []string{"w", "y"}},
...
`,
			...
			expectCompletions: map[offsetRange]fieldEmbedCompletions{
				...
				or(22, 24): {e: []string{"o", "p", "q", "x"}},
				or(24, 26): {e: []string{"y"}},
				or(26, 29): {e: []string{"o", "p", "q", "x"}},
				or1(29):    {f: []string{"p", "z"}, e: []string{"o", "q", "x"}},
				or(31, 33): {f: []string{"o", "q", "x"}},
				or(33, 36): {e: []string{"o", "q", "x"}},
				or(36, 38): {e: []string{"p", "z"}},
			},
		},
...
`,
			...
			expectCompletions: map[offsetRange]fieldEmbedCompletions{
				...
				or1(25):    {f: []string{"x"}, e: []string{"d", "l"}},
				or(26, 28): {f: []string{"x"}},
				or1(28):    {e: []string{"d", "l", "x"}},
				or1(30):    {e: []string{"d", "l", "x"}},
				or1(32):    {e: []string{"d", "l"}},
				or1(33):    {f: []string{"x"}, e: []string{"d", "l"}},
				or(34, 36): {f: []string{"x"}},
...
`,
			...
			expectCompletions: map[offsetRange]fieldEmbedCompletions{
				...
				or1(40):    {f: []string{"a", "c", "f"}, e: []string{"d", "e", "o", "p"}},
				or(41, 43): {f: []string{"a", "c", "f"}},
...
`,
			...
			expectCompletions: map[offsetRange]fieldEmbedCompletions{
				...
				or1(29):    {f: []string{"a", "c"}, e: []string{"d", "o", "p"}},
				or(30, 32): {f: []string{"a", "c"}},
...
`,
			...
			expectCompletions: map[offsetRange]fieldEmbedCompletions{
				...
				or1(27):    {f: []string{"x"}, e: []string{"d", "out", "r"}},
				or(28, 30): {f: []string{"x"}},
...
`,
			...
			expectCompletions: map[offsetRange]fieldEmbedCompletions{
				...
				or1(27):    {f: []string{"b", "d", "x", "y", "z"}, e: []string{"a", "c"}},
				or(28, 30): {f: []string{"b", "d", "x", "y", "z"}},
				or(30, 33): {e: []string{"a", "c", "x"}},
				or(34, 36): {e: []string{"a", "c"}},
				or1(36):    {f: []string{"b", "d", "x", "y", "z"}, e: []string{"a", "c"}},
				or(37, 39): {f: []string{"b", "d", "x", "y", "z"}},
				or(39, 42): {e: []string{"a", "c", "y"}},
				or(43, 45): {e: []string{"a", "c"}},
				or1(45):    {f: []string{"b", "d", "x", "y", "z"}, e: []string{"a", "c"}},
				or(46, 48): {f: []string{"b", "d", "x", "y", "z"}},
				or(48, 51): {e: []string{"a", "c", "z"}},
				or(52, 54): {e: []string{"a", "c"}},
				or1(54):    {f: []string{"b", "d", "x", "y", "z"}, e: []string{"a", "c"}},
				or(55, 57): {f: []string{"b", "d", "x", "y", "z"}},
...
`,
			expectDefinitions: map[position][]position{
				...
				ln(10, 1, "k"):     {ln(9, 1, "k")},
				ln(10, 1, "v"):     {ln(9, 1, "v")},
				ln(10, 1, "self"):  {ln(7, 1, "y")},
				ln(10, 1, "items"): {ln(8, 1, "items")},
...
`,
			...
			expectCompletions: map[offsetRange]fieldEmbedCompletions{
				...
				or1(24):    {f: []string{"b"}},
				or(25, 27): {e: []string{"V", "a", "c"}},
				or(32, 34): {e: []string{"V", "a", "c"}},
				or(35, 39): {f: []string{"x", "y"}, e: []string{"V", "a", "c"}},
				or(39, 41): {f: []string{"x", "y"}},
				or(41, 44): {e: []string{"V", "a", "c", "x", "y"}},
				or(44, 46): {e: []string{"x", "y"}},
				or1(46):    {f: []string{"x", "y"}, e: []string{"V", "a", "c"}},
				or(47, 49): {f: []string{"x", "y"}},
				or1(49):    {e: []string{"V", "a", "c", "x", "y"}},
				or1(51):    {e: []string{"V", "a", "c", "x", "y"}},
				or1(52):    {f: []string{"x", "y"}, e: []string{"V", "a", "c"}},
				or(54, 56): {f: []string{"a", "c"}},
				or1(56):    {f: []string{"b"}, e: []string{"a", "c"}},
				or(57, 59): {f: []string{"b"}},
				or(59, 62): {e: []string{"a", "b", "c"}},
				or(62, 64): {f: []string{"a", "c"}},
				or(64, 73): {f: []string{"d"}, e: []string{"a", "c"}},
				or(75, 79): {e: []string{"a", "c"}},
				or(80, 82): {e: []string{"a", "c"}},
				or1(82):    {f: []string{"d"}, e: []string{"a", "c", "v"}},
				or(83, 85): {f: []string{"d"}},
				or(85, 88): {e: []string{"a", "c", "d", "v"}},
			},
		},
